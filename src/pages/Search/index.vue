        ...
        <section class="filterCt">
          ...
          <div>
            <div class="itemType" style>
              <div class="sortName h40">商品分类：</div>
            ...
            <div class="mulBox" style="display:none">
              <div class="fx">
                <div class="mulName">商品分类：</div>
                <div class="mulList">
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品居家生活用品</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品家电(71)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品手机数码(55)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品箱包(21)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品其它酒品(20)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品清洁用品(10)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品健康保健(9)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品运动户外(6)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品精品白酒(4)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>电吹风(4)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品个护化妆(3)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>剃须刀(1)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>小米有品婴童用品(1)</span>
                  </div>
                  <div class="beyond_ellipsis1 mulItem">
                    <span>生活电器其他(1)</span>
                  </div>
              ...
              <div class="text_m">
                <button
                  type="buttom"
                  class="el-button redSure el-button--default el-button--mini"
                >
                  <span>确定</span>
                </button>
                <button
                  type="buttom"
                  class="el-button grayBtn el-button--default el-button--mini"
                >
                  <span>取消</span>
                </button>
              </div>
